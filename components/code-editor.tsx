...
export type SupportedLanguage = 'python' | 'javascript' | 'typescript' | 'html' | 'css' | 'markdown' | 'json' | 'jsx' | 'tsx' | 'c' | 'cpp';
...
// Helper function to get language extension based on language identifier
function getLanguageExtension(language: SupportedLanguage = 'python') {
  switch (language) {
    case 'python':
      return python();
    case 'javascript':
